...
class FtpClient {
 public:
  ...
  std::vector<FtpClient::DirectoryVec> ChangeDirectory(
  ...
  std::vector<FtpClient::DirectoryVec> ListDirectoryTest(
      std::string sessionIdStr);

  std::string GetWorkingDirectoryTest(std::string sessionIdStr);

  std::string ChangeWorkingDirectoryTest(std::string sessionIdStr,
                                         std::string directory);

  std::string DownloadSmallFileTest(std::string sessionIdStr,
                                    std::string filepath);

  std::string UploadSmallFileTest(std::string sessionIdStr,
                                  std::string filepath);
